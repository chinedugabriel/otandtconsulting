                ...
                <div class="project-description text-dark bg-white p-4" style="width:80%; height:100%" >
                    <div class="row my-4">
                        <div class="col-md-12 text-center">
                            ...
                            <p class="text-left  ">
                                OT&T has also facilitated the defining of Primera’s business requirements to ensure a cost-effective approach to its software development and implementation strategy
                            </p>
                        </div>
                    </div>
                    <div class="row my-4">
                        <div class="col-md-12 text-center">
                            ...
                            <p class="text-left ">
                                The solution proposed and implemented by the team included - the design and build of Primera’s network architecture - the construction of their data centre and office network/domain - trading floor and Bloomberg software and equipment installation with connections to the Nigerian Stock exchange
                            </p>
                        </div>
                    </div>
                    <div class="row my-4">
                        <div class="col-md-12 text-center h-75 w-100">
                            ...
                            <p class="text-left ">
                                Our full implementation, included with a yearly renewable support service agreement, resulted in their company seeing a 92% reduction in costs. This led Primera Africa Securities to profitability in the 1st year of business. OT&T maintains application developers within the business to automate processes that bring efficiencies to the business.
                            </p>
                        </div>
                    </div>
