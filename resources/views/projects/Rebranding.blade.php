...
<section class="project-body-height dark-sec d-flex justify-content-center align-items-md-start" style=" padding:1% 0px 0px 0px;  ">
                ...
                <div class="project-description text-dark bg-white p-3" style="width:80%; ">
                    <div class="row my-4">
                        <div class="col-md-12 text-center">
                            ...
                            <p class="text-left  ">
                                OT&T Consulting were the chosen application development vendor for the rebranding to Airtel Nigeria from Zain. This contract covered their website and all internal browser-based applications.
                            </p>
                        </div>
                    </div>
    ...
    <div class="arrow-nav d-none d-sm-none d-md-flex d-lg-flex">
        <a href="{{url("/KnowYourCustomerSystemDevelopment")}}">
        ...
        <a href="{{url("/ProcessAutomationAndDataSolutions")}}">
