...
<section class="dark-sec d-flex justify-content-center align-items-center" style="height:100vh;">
                ...
                <div class="project-description text-dark bg-white p-4" style="width:80%; height:100%" >
                    <div class="row my-4">
                        <div class="col-md-12 text-center">
                            ...
                            <p class="text-left  ">
                                OT&T tackled Airtel’s growing demand for self-service applications and delivered. Our team assisted Airtel to improve their customer experience by developing a channel for their customers to perform various service actions.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row my-4">
                        <div class="col-md-12 text-center h-75 w-100">
                            ...
                            <p class="text-left ">
                                Now customers are able to - Block or swap their lines - Download their e-bills - Buy data plans for themselves and for others - Report fraudulent activity. It’s modular structure allows our team to continue developing and adding new services with ease.
                            </p>
                        </div>
                    </div>
    ...
    <div class="arrow-nav">
        ...
        <a href="{{url("/ValueAddedServiceServiceDeliveryPortal")}}">
