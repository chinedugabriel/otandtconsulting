                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-sm-12 col-lg-6 offset-md-3 offset-lg-3 bg-light text-dark p-5">
                        <p style="font-size:18px; line-height:32px;">
                            We train and supply human resources to provide cost-effective, day-to-day management of technical responsibilities and functions critical to the success of your business; including infrastructure planning, design, setup, implementation and maintenance, proactive detection and prevention of potential issues, on-Premise and cloud-based backup, network management & network performance administration
                        </p>
                    </div>
                </div>
            </div>
