...
<section class="project-body-height d-flex justify-content-center align-items-md-start" style=" padding:1% 0px 0px 0px;  ">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-sm-12 col-lg-6 offset-md-3 offset-lg-3 bg-light text-dark p-5">
                        <p style="font-size:18px; line-height:32px;">
                            We support you in planning, organising, and allocating resources to reach your technological goals successfully and cost-effectively. OT&T develops sophisticated systems, software suites, and end-user web and mobile applications for our clients to stay relevant and perform in today’s competitive digital economy. From initial planning, through to the integration of the software and maintenance, we transform your exceptional idea into a applicable product or solution, unique to your business. Our solutions include, customised reporting software, office productivity applications, installing computer and network operating systems, business management software.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="arrow-nav d-none d-sm-none d-md-flex d-lg-flex">
        <a href="{{url("/businessAnalysisAndStrategy")}}">
