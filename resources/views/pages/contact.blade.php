...
@section('content')
    ...
    <section class="home-sec" style="background-image: url('img/main/background.png')">
        ...
        <div class="arrow-nav">
            <div class="button button-rounded button-rounded--primary mr-2">
            ...
            <div class="button button-rounded button-rounded--primary ml-2">
    ...
    <section class="contact-sec-2 green-bg">
                ...
                <div class="bg-white boder rounded hold-wrapper ">
                    ...
                    <div class="img-wrapper">
                        <img src="img/otandt_Building.jpg" alt="" >
                    </div>
                </div>
    ...
    {{-- <section class="contact-sec-2">
        <div class="container-fluid">
            <div class="row ">
                <div class="col-md-9 bg-white boder rounded hold-wrapper ">
                    <div class="wrapper-sec ">
                        <div class="row m-0">
                            <div class="col-md-12">
                                <p>
