...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="background-image: url('/img/footer-bg/background.png'); bacground-repeat:no-repeat;background-size:cover;background-position:center;">
        <nav class="nav navbar-nav mb-sm-2">
            <div class="nav-list animate__animated  animate__fadeInDown" id="nav-list">
                <div class="simple-view-nav" id="simple-vaiew-nav">
                    <a href="{{url("/services")}}" class="d-flex flex-md-row justify-content-center align-items-center" >
